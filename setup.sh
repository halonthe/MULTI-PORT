...
echo ""
wget -q https://raw.githubusercontent.com/halonthe/MULTI-PORT/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/halonthe/MULTI-PORT/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
...
sleep 2
wget https://raw.githubusercontent.com/halonthe/MULTI-PORT/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
...
echo "   - L2TP                    : 1701" | tee -a log-install.txt
